...
class FileInspector extends AbstractService
{
    ...
    {
        $maxWidth = max(512, (int)($this->app->options()->wrxtPfImgMaxW ?? 12000));
        $maxHeight = max(512, (int)($this->app->options()->wrxtPfImgMaxH ?? 12000));
        $maxMegapixels = max(1, (int)($this->app->options()->wrxtPfImgMaxMp ?? 50));
